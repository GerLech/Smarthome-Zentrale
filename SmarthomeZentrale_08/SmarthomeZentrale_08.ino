...
#define TFT_LED  15
#define TOUCH_CS 14
#define TOUCH_IRQ 2 //Für AZ-Touch alte Version #define TOUCH_IRQ 2 sont 27
#define TOUCH_ROTATION 1 //Muss für 2.4 Zoll Display 1 sein sonst 3
...
char broker[128] = "";  //Adresse des MQTT Brokers
...
char statpraefix[60] = "stat"; //Präfix für MQTT Status Nachrichten
...
void setConf(String json) {
    ...
    if (doc.containsKey("statpraefix")) strlcpy(statpraefix, doc["statpraefix"],60);
...
void setup() {
  ...
  connected = initWiFi();
  Serial.println("WiFi initialisiert");
  ...
  Serial.println("Touch Screen initialisiert");
  ...
  //}
  Serial.println("Automation initialisiert");
  //Kalibrierung laden
  loadCalibration();
  ...
  ats.addPage();
  Serial.println("Menüs und Seite 1 initialisiert");
  //falls vorhanden Seiten und Widgets aus dem SPIFFS laden 
  ats.loadAllPages();
  Serial.println("Seiten geladen");
